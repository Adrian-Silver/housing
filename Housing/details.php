...
if(isset($_GET['id'])){
    ...
    $sql ="SELECT `own_id`, `own_name`, `housetype`, `price`, `contact`, `description` FROM `owners` WHERE id='$id'";
                ...
                <form action="update_handler.php" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="own_name" value="<?php echo $name?>">
