...
$tenantname = $housetype = $price = $location ='';
$tenantname_err = $housetype_err = $price_err = $location_err ='';
...
//    process image image
    ...
    $sql = "INSERT INTO `tenants`(`id`, `tenantname`, `housetype`, `price`, `location`) VALUES (NULL ,'$tenantname','$housetype','$price','$location')";
